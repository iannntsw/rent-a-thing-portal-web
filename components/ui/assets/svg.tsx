  ...
  return (
    ...
    >
      <path
        ...
        stroke={cn(stroke ? stroke : "#FBF9F6")}
        strokeWidth="1.25"
        strokeLinecap="round"
...
export const ChatIcon: React.FC<SVGComponentProps> = ({
  stroke,
  className,
}) => {
  return (
    ...
    >
      <path
        d="M21 15C21 15.5304 20.7893 16.0391 20.4142 16.4142C20.0391 16.7893 19.5304 17 19 17H8L3 21V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H19C19.5304 3 20.0391 3.21071 20.4142 3.58579C20.7893 3.96086 21 4.46957 21 5V15Z"
        stroke={cn(stroke ? stroke : "#FBF9F6")}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const NotificationCount = ({
  ...
  return (
    <span
      className={cn(
        "flex h-5 w-5 items-center justify-center overflow-hidden rounded-full bg-white font-inter text-[10px] font-semibold text-white",
        className,
      )}
    >
      {showCount}
  ...
  return (
    ...
    >
      <rect
        ...
        strokeWidth="1.5"
      />
      <circle cx="18" cy="6" r="1" fill={cn(fill ? fill : "#FBF9F6")} />
      <circle
        cx="12"
        cy="12"
        r="5"
